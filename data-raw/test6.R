...
regCtrl.DNN    <- list(machine = "regDNN", n.batch = 100, n.epoch = 500, activate = "elu",
                       l1.reg = 10**-4, plot = FALSE , learning.rate.adaptive = "adagrad", early.stop.det = 100)
wclsCtrl.DNN   <- list(machine = "wclsDNN", n.batch = 100, n.epoch = 500, activate = "elu",
                       l1.reg = 10**-4, plot = FALSE, learning.rate.adaptive = "adagrad", early.stop.det = 100)
...
cvCtrl.list <- list(list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = 75))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = 75)))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(75, 75)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(75, 75))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(75, 75, 75)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(75, 75, 75))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(75, 75, 75, 75)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(75, 75, 75, 75))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = 100))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = 100)))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(100, 100)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(100, 100))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(100, 100, 100)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(100, 100, 100))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(100, 100, 100, 100)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(100, 100, 100, 100))))),
