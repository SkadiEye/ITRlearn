...
regCtrl.DNN    <- list(machine = "regDNN", n.hidden = c(10, 10, 10), n.batch = 10, n.epoch = 250, activate = "elu",
                       l1.reg = 10**-4, plot = TRUE , learning.rate.adaptive = "adagrad", early.stop.det = 100, accel = "rcpp")
wclsCtrl.DNN   <- list(machine = "wclsDNN", n.hidden = c(10, 10, 10), n.batch = 10, n.epoch = 250, activate = "elu",
                       l1.reg = 10**-4, plot = TRUE, learning.rate.adaptive = "adagrad", early.stop.det = 100, accel = "rcpp")
