...
cvCtrl.list <- list(list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 10, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 10, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 20, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 20, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 30, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 30, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 40, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 40, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 50, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 50, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 75, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 75, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         ...
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 100, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 150, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 150, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         ...
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 200, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 300, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 300, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 400, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 400, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
                    list(ITR = "itrDOWL",
                         regCtrl = list(machine = "ensemble", n.ensemble = 500, best.opti = TRUE,
                                        esCtrl = append(regCtrl.DNN, list(n.hidden = c(30, 30, 30)))),
                         wclsCtrl = list(machine = "ensemble", n.ensemble = 500, best.opti = TRUE,
                                         esCtrl = append(wclsCtrl.DNN, list(n.hidden = c(30, 30, 30))))),
