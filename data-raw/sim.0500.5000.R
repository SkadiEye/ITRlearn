...
set.seed(as.numeric(opt$seed)*1000)
n.sample = 500
n.p = 5000
rho = 1
...
regCtrl.DNN    <- list(machine = "regDNN", n.batch = 10, n.epoch = 1000, activate = "elu",
                       l1.reg = 10**-4, plot = FALSE , learning.rate.adaptive = "adagrad", early.stop.det = 100, accel = "rcpp")
wclsCtrl.DNN   <- list(machine = "wclsDNN", n.batch = 10, n.epoch = 1000, activate = "elu",
                       l1.reg = 10**-4, plot = FALSE, learning.rate.adaptive = "adagrad", early.stop.det = 100, accel = "rcpp")
...
write.csv(wfmodl@performances, paste(opt$seed, ".0515.performance.csv", sep=''))
