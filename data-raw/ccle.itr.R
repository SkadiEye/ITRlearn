...
load("/ufrc/zou/xlmi/personalizedMedicine/CCLEdata/Response/CCLE_response_v3.RData")
load("/ufrc/zou/xlmi/personalizedMedicine/CCLEdata/geneExp/CCLE_exp.RData")
...
regCtrl.DNN    <- list(machine = "regDNN", n.batch = 10, n.epoch = 500, activate = "elu", accel = "rcpp", norm.x = FALSE,
                       l1.reg = 10**-4, plot = TRUE , learning.rate.adaptive = "adagrad", early.stop.det = 100)
wclsCtrl.DNN   <- list(machine = "wclsDNN", n.batch = 10, n.epoch = 500, activate = "elu", accel = "rcpp", norm.x = FALSE,
                       l1.reg = 10**-4, plot = TRUE, learning.rate.adaptive = "adagrad", early.stop.det = 100)
